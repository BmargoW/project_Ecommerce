...
#
# category_grass.average_products()
#
# print(category_smartphones.products)
#
# print(Category.product_count)
#
print(category_grass.average_products())
# try:
...
# if __name__ == "__main__":  # pragma no cover
#     product1 = Product(
#         "Samsung Galaxy S23 Ultra", "256GB, Серый цвет, 200MP камера", 180000.0, 3
#     )
...
#     print(category1.average_products())
